...
from model_core.data.util import BaseDataset
from model_core.data.base_data_module import BaseDataModule, load_and_print_info
from model_core.data.emnist import EMNIST
...
class EMNISTLines(BaseDataModule):
    ...
    def _generate_data(self, split: str) -> None:
        ...
        from model_core.data.sentence_generator import SentenceGenerator
