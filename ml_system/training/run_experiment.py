...
from model_core.lit_models import base
...
def _import_class(module_and_class_name: str) -> type:
    """Import class from a module, e.g. 'model_core.models.MLP'"""
...
def _setup_parser():
    ...
    data_class = _import_class(f"model_core.data.{temp_args.data_class}")
    model_class = _import_class(f"model_core.models.{temp_args.model_class}")
